...
BLOG_AUTHOR = "Adam Reid"
BLOG_TITLE = "adamreid.ca"
SITE_URL = "http://adamreid.ca"
BLOG_EMAIL = "adam@adamreid.ca"
BLOG_DESCRIPTION = "Sporratic updates from Adam"
...
REDIRECTIONS = [
    ("2012/05/15/Kickstarting-Puppet-On-Centos4/index.html", "/posts/Kickstarting-Puppet-On-Centos4.html"),
    ("2012/05/21/Kickstarting-Vagrant-On-Centos4/index.html", "/posts/Kickstarting-Vagrant-On-Centos4.html")
]
...
DEPLOY_COMMANDS = ['cd ../adamreid.github.com && EDITOR=vim git commit -a && git push']

# Where the output site should be located
# If you don't use an absolute path, it will be considered as relative
# to the location of conf.py
OUTPUT_FOLDER = '../adamreid.github.com'
